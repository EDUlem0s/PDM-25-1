...
void main() async {
  // Objetos de exemplo
  var cliente = Cliente(codigo: 1, nome: 'Eduardo Lemos', tipoCliente: 0);
  var vendedor = Vendedor(codigo: 1, nome: 'Doquinha Nana', comissao: 5.5);
  var veiculo = Veiculo(
    codigo: 101,
    descricao: 'Carro celta 1.0',
    valor: 25000.00,
  );
  var itens = [
    ItemPedido(
  ...
  final smtpServer = gmail("eduardo.vitoriano14@aluno.ifce.edu.br", "orgv zfat whph ncwj");

  final message =
      Message()
        ..from = Address("eduardo.vitoriano14@aluno.ifce.edu.br", 'Eduardo')
